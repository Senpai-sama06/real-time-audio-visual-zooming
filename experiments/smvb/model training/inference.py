...
# ==========================================
# 1. Model Architecture (Must match Training: 4 Channels)
# ==========================================
...
class PyTorchBeamformer:
    ...
    def predict_mask(self, log_mag, raw_ipd):
        ...
        # Stack 4 Channels: LogMag, Sin, Cos, Freq (NO MSC)
        input_np = np.stack([log_mag, sin_ipd, cos_ipd, f_map_tiled], axis=-1)
...
def enhance_audio(run_name, input_path, model_path):
    ...
    for i in range(num_chunks):
        ...
        # 1. AI Mask (Only requires LogMag and IPD)
...
MODEL_FILE_PATH = "mask_estimator_phy_final.pth"
RUN_NAME = "kaggle_test_3"
