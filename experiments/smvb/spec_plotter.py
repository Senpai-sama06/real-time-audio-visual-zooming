...
def plot_spectrograms_side_by_side(audio_file_1, audio_file_2):
    ...
    img1 = librosa.display.specshow(S_db1, sr=sr1, hop_length=hop_length, 
                                    x_axis='time', y_axis='log', ax=axes[0], cmap='inferno')
    axes[0].set_title(f'Spectrogram: 1')
    fig.colorbar(img1, ax=axes[0], format="%+2.0f dB")

    # --- Plot Second Audio ---
    img2 = librosa.display.specshow(S_db2, sr=sr2, hop_length=hop_length, 
                                    x_axis='time', y_axis='log', ax=axes[1], cmap='inferno')
    axes[1].set_title(f'Spectrogram: 2')
...
file_path_1 = '/home/communications-lab/ramakrishna/real-time-audio-visual-zooming/experiments/smvb/model training/debug_audio/epoch_001/target_audio.wav'
file_path_2 = '/home/communications-lab/ramakrishna/real-time-audio-visual-zooming/experiments/smvb/model training/debug_audio/epoch_001/mask_truth_audio.wav'
